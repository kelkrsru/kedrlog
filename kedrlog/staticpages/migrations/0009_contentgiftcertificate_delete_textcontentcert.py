# Generated by Django 4.2.4 on 2024-03-31 09:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('staticpages', '0008_textcontentcert'),
    ]

    operations = [
        migrations.CreateModel(
            name='ContentGiftCertificate',
            fields=[
                ...
                ('gift_certificates', models.ManyToManyField(help_text='Выберите подарочные сертификаты для отображения на странице Подарочные сертификаты', related_name='contents', to='core.giftcertificate', verbose_name='Подарочные сертификаты')),
            ],
            options={
